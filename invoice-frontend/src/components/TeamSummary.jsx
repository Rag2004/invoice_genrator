...
//   // ✅ FIX: Enhanced addTeamMember with better validation
//   const addTeamMember = () => {
//     console.log('➕ Adding team member...', {
//       teamOptionsLength: teamOptions.length,
//       firstMember: teamOptions[0],
//       baseHourlyRate
//     });
...
//     console.log('✅ New team member created:', newItem);
...
//   // ✅ FIX: Sync stage structure with items
//   useEffect(() => {
//     const items = invoice.items || [];
...
//   // ✅ FIX: Update team member with proper recalculation
//   const updateTeamMember = (id, field, value) => {
//     console.log('🔄 Updating team member:', { id, field, value });
...
//         // ✅ FIX: When name changes, update factor and memberId
//         if (field === 'name') {
//           const member = teamOptions.find((m) => m.name === value);
          
//           console.log('👤 Member changed to:', {
//             newName: value,
//             foundMember: member,
//             newFactor: member?.baseFactor || member?.factor || 1
//           });
...
//         // For other field updates, recalculate with existing factor
...
//   // ✅ FIX: Update stage hours with recalculation
...
//   // ✅ FIX: Auto-add first team member when ready
//   useEffect(() => {
...
//       baseHourlyRate > 0
//     ) {
//       console.log('✅ Auto-adding first team member');
//       addTeamMember();
//     }
//   }, [teamOptions, baseHourlyRate, loadingTeam]);

//   // ✅ FIX: Update rates when baseHourlyRate changes
//   useEffect(() => {
//     const items = invoice.items || [];
//     if (!items.length || !baseHourlyRate) return;

//     console.log('💰 Updating rates for baseHourlyRate change:', baseHourlyRate);
...
//                 </div>
//               ))}
//               <button className="btn btn-ghost btn-sm" type="button" onClick={() => addSubStage(stage.id)}>
//                 + Add Sub-Stage
//               </button>
//             </div>
...
//         {/* ✅ FIX: Better loading and empty states */}
//         {loadingTeam && (
...
//                     Price (₹)
//                   </th>
//                   <th className="work-th-main work-th-icon" rowSpan={hasStages ? 3 : 1} />
//                 </tr>
//                 {hasStages && (
//                   <tr>
//                     {stages.map((st) => {
...
//                       return (
//                         <th key={`stage-${st.id}`} colSpan={span} className="work-th-stage-group">
//                           {stageHeaderTitle(st)}
//                         </th>
//                       );
//                     })}
...
//                       if (sub.length === 0) {
//                         return (
//                           <th key={`sub-${st.id}`} className="work-th-substage">
//                             {st.stage || 'Task'}
//                           </th>
//                         );
//                       }
//                       return sub.map((subStage) => (
//                         <th key={`sub-${subStage.id}`} className="work-th-substage">
//                           {subStage.label || 'Task'}
//                         </th>
//                       ));
//                     })}
...
//                           if (sub.length === 0) {
//                             return (
//                               <td key={`${item.id}-${sid}`} className="work-cell-narrow">
//                                 <input
//                                   type="number"
//                                   className="input"
//                                   min="0"
...
//                             return (
//                               <td key={`${item.id}-${sid}-${subId}`} className="work-cell-narrow">
//                                 <input
//                                   type="number"
//                                   className="input"
//                                   min="0"
...
//                         <input type="text" className="input input-readonly" readOnly value={totalHours} />
//                       </td>
