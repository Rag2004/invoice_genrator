...
export default function StagesConfig({
  ...
  console.log('Rendering TeamSummary v2', { showOnlyTable, showOnlyStages, stages: invoice.stages });
            ...
            <div className="work-section-header">
              <div className="work-section-title-block">
                ...
                <p className="work-section-subtitle">
                  Configure stages and their sub-stages. These become columns in the table below.
                </p>
              </div>
              <button className="btn btn-primary btn-sm" type="button" onClick={addStage}>
                + Add Stage
              </button>
            </div>
          )}
                ...
                {(invoice.stages || []).map((stage, stageIdx) => {
                  ...
                  return (
                    <div key={stageKey} className="stage-card">
                      {/* Row 1: Badge + Title + % + Days + Delete */}
                      <div className="stage-card-header">
                        <div className="stage-badge">{stageIdx + 1}</div>
                        <div className="stage-inputs-row">
                          <div className="stage-input-group title">
                            <input
                              className="input"
                              type="text"
                          ...
                          <div className="stage-input-group pct">
                            <input
                              className="input"
                              type="text"
                          ...
                          <div className="stage-input-group days">
                            <input
                              className="input"
                              type="number"
                              min="0"
                      ...
                      {/* Row 2: Substage chips inline */}
                      <div className="stage-substages-inline">
                        {(stage.subStages || []).map((sub, subIdx) => (
                          <div
                            key={sub.id || `${stageKey}-sub-${subIdx}`}
                            className="substage-tag"
                          >
                            <input
                              className="input"
                              type="text"
          ...
          {(invoice.stages || []).length > 0 && (
            <div className="stage-footer">
              ...
              <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
                <div className="stage-footer-stat">
                  <span className="stage-footer-stat-label">Percentage:</span>
                  <div className="stage-pct-bar">
                    <div
                      className="stage-pct-bar-fill"
                      style={{
                  ...
                  <span
                    className="stage-footer-stat-value"
                    style={{
                ...
                <div className="stage-footer-stat">
                  <span className="stage-footer-stat-label">Total Days:</span>
                  <span className="stage-footer-stat-value" style={{ color: 'var(--gray-800)' }}>
                    {totalDays}
                  </span>
                </div>
              </div>
