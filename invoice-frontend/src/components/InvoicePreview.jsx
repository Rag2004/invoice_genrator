      ...
      <div className="invoice-body">
        ...
        <div className="invoice-meta">
          <div className="invoice-meta-section">
            ...
            {projectName && (
              <p style={{ fontWeight: 600, marginBottom: 2 }}>{projectName}</p>
            )}
        ...
        {/* MAIN BOTTOM GRID:
            1) Stages, Inclusions & Timeline
            2) Totals (so stages always come first in PDF) */}
        <div className="invoice-bottom-grid">
          {/* STAGES FIRST (in DOM) */}
          <section className="invoice-section invoice-stages-section">
            <div className="invoice-section-header">
              <h4 className="invoice-section-title">
                Stages, Inclusions &amp; Timeline
              </h4>
          ...
          {/* TOTALS SECOND (visually side-by-side on desktop) */}
          <section className="invoice-totals-card">
            <div className="summary-line subtotal">
              <span>Subtotal:</span>
              <span style={{ fontWeight: 600 }}>
                {formatCurrency(subtotal)}
            ...
            {/* INTERNAL-ONLY: Hidden for client PDF via CSS print rules */}
            <div className="earnings-box earnings-internal">
              <div className="service-fee">
                Service Fee ({serviceFeePct || 0}%):{' '}
                {formatCurrency(serviceFee)}
              </div>
              <div className="earnings">
                Your Earnings: {formatCurrency(earnings)}
